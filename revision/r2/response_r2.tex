...
This is a good point, we have clarified our use of this word in the two areas we used it without additional context ( \llabel{bias1}, \llabel{bias1}). % emw18Oct: fix these refs to main text!
