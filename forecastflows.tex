...
this step might reveal that some parameters are highly non-identifiable, % If the model fails to recover known parameter values, this flags % not sure about this word
...
\begin{minipage}[t]{\linewidth}
    ...
    \vspace{-0.6cm}\captionof{figure}{Caption}\label{fig:trends}
\end{minipage}
\vspace{0.1cm}
