...
% Such training leaves a large number of ecologists adrift later when asked to simulate any sort of simple model because they were never taught what a model fundamentally is. % jdavies15april: this may be true, but I am not sure we want to broadly disparage ecologists
