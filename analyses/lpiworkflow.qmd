...
m <- t(sapply(names, function(n) retrodictions[[n]][1:10]))

ggplot() +
  geom_density(data = data.frame(retro = m[,1]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,2]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,3]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,4]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,5]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,6]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,7]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,8]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,9]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .5) +
  geom_density(data = data.frame(retro = m[,10]), aes(x = retro), alpha = 0.2, col = 'darkred') +
  geom_density(data = data.frame(obs = log(data$y)), aes(x = obs), alpha = 0.2, linetype = 'solid', color = 'white', linewidth = 1.5) +
  geom_density(data = data.frame(obs = log(data$y)), aes(x = obs), alpha = 1, linetype = 'dashed') +
  theme_bw() +
