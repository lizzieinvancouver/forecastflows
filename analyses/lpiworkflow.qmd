...
Here we start by visually comparing 9 draws from the posterior predictive distribution of counts (across all species and populations, red line) to observed data (black dashed line):
```{r}
#| fig-height: 5
#| fig-width: 5
#| echo: false
...
names <- paste0('logy_pred[', 1:data$N, ']')
retrodictions <- extract(fit, pars = names)
m <- t(sapply(names, function(n) retrodictions[[n]][1:30]))

ggplot() +
  geom_density(data = data.frame(retro = m[,1]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,2]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,3]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,4]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,5]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,6]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,7]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,8]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,9]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,10]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,11]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,12]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,13]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,14]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,15]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,16]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,17]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,18]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,19]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,20]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,21]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,22]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,23]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,24]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,25]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,26]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,27]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,28]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,29]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(retro = m[,30]), aes(x = retro), alpha = 0.2, col = 'darkred', linewidth = .1) +
  geom_density(data = data.frame(obs = log(data$y)), aes(x = obs), alpha = 0.2, linetype = 'solid', color = 'white', linewidth = 1.5) +
  geom_density(data = data.frame(obs = log(data$y)), aes(x = obs), alpha = 1, linetype = 'solid') +
  theme_bw() +
  labs(y = 'Density', x = 'Counts (log-scale)')
