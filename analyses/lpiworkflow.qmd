...
Here we start by visually comparing the posterior predictive distribution of the predicted counts (across all species and populations, red line) to observed data (black dashed line):
```{r}
#| fig-height: 3
#| fig-width: 3
#| echo: false
